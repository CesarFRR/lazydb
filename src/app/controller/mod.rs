...
// Submódulos del event loop (impl App repartidos por responsabilidad):
// teclado en keys.rs, mouse en mouse.rs, el resto en este archivo.
mod key_input;
mod mouse;
...
} // cierre de impl App (el bloque mouse se extrajo a mouse.rs)
